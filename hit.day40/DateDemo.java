...
public class DateDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println("\t");
		System.out.println(IDate.getDayOfMonth());
		
		System.out.println(IDate.getDayOfYear());
		
		System.out.println(IDate.getDayOfWeek());

		System.out.println(IDate.getDayOfMonth());
		
		LocalDate yesterday = IDate.minusDays(1);
		LocalDate tomorrow = yesterday.plusDays(2);
		System.out.println("Today date:"+IDate);
		System.out.println("Yesterday date:"+yesterday);
		System.out.println("Tomorrow date:"+tomorrow);
		
		System.out.println(IDate.isLeapYear());
		
		LocalDate leap=LocalDate.of(2024, 1, 1);
		System.out.println(leap.isLeapYear());
		
		LocalDateTime idt=leap.atTime(8,30,12);
		System.out.println(idt);
		
		LocalDateTime iDateTime=LocalDateTime.now();
		System.out.println(iDateTime);
		
		System.out.println(iDateTime.minusHours(2));
		System.out.println(iDateTime.plusDays(1));
		...
		ValueRange r2 = month2.range(ChronoField.MONTH_OF_YEAR);
		...
		LocalDateTime idt1 = LocalDateTime.of(2017,Month.JANUARY, 19,15 ,26);
		ZoneId india =ZoneId.of("Asia/Kolkata");
		ZonedDateTime zone11 = ZonedDateTime.of(idt1, india);
